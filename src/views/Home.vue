...
<template>
  <div>
    <section>
      ...
      <router-link to="/contact" class="btn no-underline"
        >Message Me</router-link
      >
    </section>

    <section class="mt-20">
      <h2 class="text-2xl mb-6 font-display font-bold">
        Virtual Appearances
      </h2>
      ...
      <ul class="list-disc ml-5 appearance-list">
        <li>
          <a
            class="underline"
            href="https://www.youtube.com/watch?v=2t7zy0hscnM"
          >
