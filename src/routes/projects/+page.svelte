	...
	const projects = [
		{
			...
			title: 'Heygumball',
			description:
				"Heygumball is a platform for tattooers to have more refined control over their schedule, availability, and everything in between. It's a full-stack project with a Laravel API, a Vue front-end, and a mobile app built in React Native.",
			url: 'https://heygumball.com',
			tech: ['Laravel', 'Vue', 'Tailwind', 'React Native'],
			github: null
		},
		{
			id: 0,
...
<section>
	<ul>
		{#each projects as project}
			<li class="mb-20">
				<h2 class="mb-4 text-xl font-bold text-red-500 lg:text-2xl font-display">
					{project.title}
				</h2>
