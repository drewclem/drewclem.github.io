  ...
  <Layout>
    ...
    <div className='hero-wrapper'>
      <div className='hero'>
        ...
        <p>Hi! I'm just a dad trying to do right for his wife and daughter! I work as a front-end engineer at <a href="https://layerframe.co" style={{color: "var(--red)"}} target='_blank' rel='noopener noreferrer'>Layerframe</a> and <a href="https://www.fostercommerce.com/" style={{color: "var(--red)"}} target='_blank' rel='noopener noreferrer'>Foster Commerce</a>! I spend my spare time exploring the JAMstack world and building <a href='https://protege.dev' style={{color: "var(--red)"}} target='_blank' rel='noopener noreferrer'>Protege.dev</a>.</p>
      </div>
